...
class PostgreSQL:
    ...
    def inserir_dadosSteamBD(cls, arg_dictDados: dict):
        ...
        try:
            ...
            INSERT INTO steam_bd (
                ...
                distribuidores, preco, metacritic_score, categorias, genero, data_lancamento, reviews, type, ultima_atualizacao
    ...
    @classmethod
    def buscar_steam_unificado(cls, arg_intAppid: int) -> dict | None:
        """
        Busca um jogo na tabela steam_unificado.
        ...
        try:
            ...
            var_strSQL = "SELECT * FROM steam_unificado WHERE appid = %s;"
            ...
            logger.error(f"Erro ao buscar AppID {arg_intAppid} em steam_unificado: {e}")
            return None
    
    @classmethod
    def buscar_todos_steam_unificado(cls, arg_intLimit: int = None) -> list[dict]:
        """
        Busca todos os jogos da tabela steam_unificado.
        ...
        try:
            ...
            var_strSQL = "SELECT * FROM steam_unificado"
            if arg_intLimit:
                var_strSQL += f" LIMIT {arg_intLimit}"
            var_strSQL += ";"
            ...
            logger.error(f"Erro ao buscar todos de steam_unificado: {e}")
            return []