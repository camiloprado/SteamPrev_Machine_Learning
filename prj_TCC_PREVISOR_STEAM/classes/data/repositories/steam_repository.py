...
class SteamRepository(BaseRepository):
    """
    Repositório para operações com dados da Steam.
    Todas as queries relacionadas a steam_raw, steam_generico, steam_unificado.
    """
    ...
    def buscar_jogos_desatualizados(cls, arg_strNomeTabela: str = "steam_raw", arg_intDiasAtualizacao: int = None, arg_intLimite: int = None) -> list[dict]:
        ...
        try:
            ...
            var_listDados = cls._executar_query(var_strSQL, (var_dataCorte,))
    ...
    def inserir_dadosSteamRaw_Bulk(cls, arg_listDados: list) -> None:
        ...
        try:
            ...
            # Executa a inserção em batch usando o método do BaseRepository
            cls._executar_bulk_insert(var_strSQL, var_listValores)
            logger.info(f"Inserção em bulk concluída: {len(var_listValores)} registros processados em steam_raw.")
            ...
            if var_listAppidsInseridos:
                ...
                cls._executar_bulk_insert(var_strSQLGenerico, var_listAppidsInseridos)
    ...
    def inserir_dadosSteamGenerico(cls, arg_listDadosGerais: list) -> bool:
        ...
        try:
            ...
            for var_intIndex in range(0, len(var_listDadosParaInserir), 5000):
                ...
                cls._executar_bulk_insert(var_strSQL, var_listValores)
                var_intTotalInserido += len(var_listValores)
    ...
    def inserir_steam_unificado(cls, arg_dictDados: dict) -> None:
        ...
        try:
            ...
            cls._executar_comando(var_strSQL, var_tupleValores)
